            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <p class="card-text">Réalisateur: <small><a href="./index.php?action=showDetailsPerson&id=<?= $details['id_person'] ?>&table=director"><span><?= $director['firstName'] ?></span><span><?= $director['lastName'] ?></span></a></small></p>

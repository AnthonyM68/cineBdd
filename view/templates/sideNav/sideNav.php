...
<ul class="d-flex flex-column">
    ...
    <li><a href="./index.php?action=listMoviesAdmin"><i class="fa fa-list-ol fa-2x" aria-hidden="true"></i></a></li>
    <li><a href="./index.php?action=insertMovieForm"><i class="fa fa-plus-circle fa-2x" aria-hidden="true"></i></a></li>
</ul>
<?php
